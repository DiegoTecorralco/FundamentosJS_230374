...
console.log(`Más adelante podremos tranformae el contenido de los STRING usando los métodos y funciones específicas, como convertir su valor a mayúsculas: ${alumno} => ${alumno.toUpperCase()}`)
console.log(`o en su defecto en minúsculas: ${producto} => ${producto.toLowerCase()}`)
...
console.log(`¿Es 5 === Symbol(5)?, antes de compararlos analizamos que tipo de dato son: siendo el numero1 del tipo ${typeof(numero1)} y el numero5 es ${typeof(numero5)}`)
...
//Supongamos que estamos programandi una Red Social, tipo Facebook, en la parte de la información se publicará en el perfil del usuario

// si el usuario no ha iniciado en el dispositivo móvil i en la aplicación web, puede explorar contenido de acceso público. yy no existira información para mostrar.

//En la HU (Historia de Usuario), que el usuario desea logearse deberá ingresar su numero telefónico o correo electrónico y una contraseña que deberemos guardar en las variables previamente declaradas.

//Supongamos que el usuario: Dieco Tecorraco con con correo electrónico teco@gmail.com desea ingresar su contraseña: pass123

nombreUsuario= " teco@gmail.com";
passUsuario= "pass123";
...
console.log(`El usuario: ${nombreUsuario}, se ha logeado exitosamente, al tener acceso a su información de perfil podemos deducir que es del género ${generarUsuario} y que su estatus de relación es: ${estatusRelacionSentimental} y su ultima publicación la realizó el: ${fecha_ultimoPost}`);

//Comparando NULL vs UNDEFINED
//Si bien UNDEFINED y NULL tienen el mismo valor, no tienen el mismo tipo de dato

//Dado que Diego Tecorralco es dell genero Masculino y denota que su estatus 
generarUsuario="M";
